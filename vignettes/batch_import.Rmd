...
The batch-imported metadata is the same, with a single row for each participant. Note
that reading in metadata this way makes it easy to identify any differences in eye
tracker settings across participants (e.g. sample rate, eye tracked):
